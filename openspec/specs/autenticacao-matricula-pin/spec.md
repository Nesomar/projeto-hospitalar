# autenticacao-matricula-pin

## Purpose

Autenticação de colaboradores da UPA Nordeste via matrícula (6 dígitos) + PIN (4 dígitos), com emissão de JWT
e controle de acesso por perfil (RBAC). Substitui a autenticação LDAP/AD original do protótipo.
