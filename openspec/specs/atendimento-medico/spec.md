...
Transições de estado do atendimento médico (UC007-UC010 / `docs/03-casos-uso.md`): iniciar atendimento,
dar alta, solicitar exames complementares e retomar atendimento, restritas a perfil "medico", cada uma
registrando uma evolução para auditoria.
